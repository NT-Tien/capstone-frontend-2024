            ...
            <Tabs
               ...
               items={[
                  ...
                  },
                  {
                     ...
                     children: (
                        <div className="grid grid-cols-1">
                           {taskGrouped.headstaffConfirm.length === 0 && taskGrouped.inProgress.length === 0 && (
                              <div className="grid place-items-center py-12">
                                 <Empty description="Không có tác vụ" />
                              </div>
                           )}
                           {[...taskGrouped.headstaffConfirm, ...taskGrouped.inProgress].map((task, index, array) => (
                              <Fragment key={task.id}>
                                 {index !== 0 && (
                  ...
                  },
                  {
                     ...
                     children: (
                        <div className="grid grid-cols-1">
                           ...
                           {[...taskGrouped.completed, ...taskGrouped.cancelled].map((task, index, array) => (
                              <Fragment key={task.id}>
                                 {index !== 0 && (
                                    <div className="grid grid-cols-[24px_1fr] gap-4">
                                       {(array[index - 1] === undefined ||
