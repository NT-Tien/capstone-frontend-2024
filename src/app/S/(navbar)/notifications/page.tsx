...
import S_Notifications_ClickHandler from "@/features/staff/notifications-handler"
                        ...
                        renderItem={(n, i) => (
                           <ClickableArea
                              ...
                              onClick={() => {
                                 ...
                                 S_Notifications_ClickHandler(n, router)
                              }}
                           >
                              <List.Item
                                 className={cn(
                                    "w-full border-2 border-b-0 border-orange-200 bg-orange-100 p-2.5",
                                    n.seenDate && "bg-white",
                                    i === 0 && "rounded-t-lg",
