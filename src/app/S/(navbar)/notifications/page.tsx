...
import { Avatar, Divider, List, Space, Spin, Empty, Card } from "antd"
...
import useStaff_notificationsRedirecter from "@/features/staff/useNotificationsRedirect"
import staff_queries from "@/features/staff/queries"
import { NotificationsIdentifierMapper } from "@/features/staff/notifications"
...
function Page() {
   ...
   const redirecter = useStaff_notificationsRedirecter()

   const api_notifications = staff_queries.notifications.all({})
   ...
   return (
      <div className={"relative"}>
         <div className={"absolute left-0 top-0 h-[72px] w-full bg-staff"} />
         <PageHeaderV2
