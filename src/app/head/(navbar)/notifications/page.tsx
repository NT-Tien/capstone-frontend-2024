...
import HD_Notifications_ClickHandler from "@/features/head-department/notifications-handler"
                        ...
                        renderItem={(n, i) => (
                           <ClickableArea
                              ...
                              onClick={() => {
                                 ...
                                 HD_Notifications_ClickHandler(n, router)
                              }}
                           >
                              <List.Item
                                 className={cn(
                                    "w-full border-2 border-b-0 border-blue-200 bg-blue-100 p-2.5",
                                    n.seenDate && "bg-white",
                                    i === 0 && "rounded-t-lg",
                              ...
                              >
                                 <List.Item.Meta
                                    title={<h3 className="text-medium text-sm truncate">{n.title}</h3>}
                                    description={<p className="text-sm text-neutral-500 truncate">{n.body}</p>}
                                 />
                              </List.Item>
                           </ClickableArea>
                        )}
