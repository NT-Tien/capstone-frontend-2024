...
export default function RootHeader({
  ...
  const changeLanguage = (lng: string) => {
   ...
   return (
      ...
      {currentLanguage === 'vie' && (
        <Button onClick={() => changeLanguage('eng')} style={{ display: 'flex', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.8)', color: '#FFFFFF', border: 0, borderRadius: '999px', padding: '0.5rem' }}>
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32" style={{ marginRight: '5px' }}>
