...
function RequestsListByDeviceSection(props: Props) {
      ...
      <ProTable<RequestDto>
         ...
         columns={[
            ...
            },
            {
               ...
               valueType: "select",
               valueEnum: Object.keys(FixRequestStatus).reduce((acc: { [key: string]: { text: string } }, key) => {
...
export default RequestsListByDeviceSection
