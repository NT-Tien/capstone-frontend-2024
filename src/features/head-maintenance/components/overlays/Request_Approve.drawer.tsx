...
const Request_ApproveDrawer = forwardRef<ApproveRequestDrawerRefType, Props>(function Component(
   { children, ...props },
   ref,
) {
   ...
   return (
      <>
         ...
         >
            ...
            <Issue_CreateDetailsDrawer onFinish={handleCreateOrUpdateSingleIssue} ref={createSingleIssueDrawerRef} />
         </Drawer>
      </>
   )
})

export default Request_ApproveDrawer
