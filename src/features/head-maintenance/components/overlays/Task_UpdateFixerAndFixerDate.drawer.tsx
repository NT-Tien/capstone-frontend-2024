...
export type Task_UpdateFixerAndFixerDateRefType = {
   handleOpen: (
      taskId: string,
      initialValues: {
         priority?: boolean
...
const Task_UpdateFixerAndFixerDate = forwardRef<Task_UpdateFixerAndFixerDateRefType, Props>(function Component(
   { ...props },
   ref,
) {
...
export default Task_UpdateFixerAndFixerDate
