...
type Issue_Resolve_DisassembleReplacementDrawerProps = {
   issue?: IssueDto
   onSuccess?: () => void
}
...
function Issue_Resolve_DisassembleReplacementDrawer(props: Props) {
...
export default Issue_Resolve_DisassembleReplacementDrawer
export type { Issue_Resolve_DisassembleReplacementDrawerProps }
