...
type Issue_Resolve_InstallReplacementDrawerProps = {
   issue?: IssueDto
   onSuccess?: () => void
}
...
function Issue_Resolve_InstallReplacementDrawer(props: Props) {
...
export default Issue_Resolve_InstallReplacementDrawer
export type { Issue_Resolve_InstallReplacementDrawerProps }
