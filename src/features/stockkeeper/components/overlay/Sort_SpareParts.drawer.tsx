...
const Sort_SparePartsDrawer = forwardRef<SortDrawerRefType, Props>(function Component(props, ref) {
         ...
         >
            ...
            >
               <Space direction="vertical" className="w-full">
                  ...
                  <Radio value={"name" as Sort["type"]}>Tên linh kiện</Radio>
                  <Divider className="my-1" />
                  <Radio value={"quantity" as Sort["type"]}>Số lượng trong kho</Radio>
               </Space>
...
export default Sort_SparePartsDrawer
