...
const Sort_TasksDrawer = forwardRef<SortDrawerRefType, Props>(function Component(props, ref) {
...
export default Sort_TasksDrawer
export type { Sort, SortDrawerRefType }
