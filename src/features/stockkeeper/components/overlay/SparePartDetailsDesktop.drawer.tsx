...
const SparePartDetailsDesktopDrawer = forwardRef<SparePartDetailsDrawerRefType, Props>(function Component(props, ref) {
...
export default SparePartDetailsDesktopDrawer
